...
class AttendeeMinimalSerializer(serializers.ModelSerializer):
    ...
    # photo = serializers.CharField(read_only=True)  # trying DevExtreme dxFileUploader
    photo = serializers.ImageField(use_url=True, read_only=True)   # trying DevExtreme dxFileUploader
