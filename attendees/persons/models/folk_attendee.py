...
class FolkAttendee(TimeStampedModel, SoftDeletableModel):
    ...
    folk = models.ForeignKey('persons.Folk', null=False, blank=False, on_delete=models.CASCADE)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['folk', 'attendee'], condition=models.Q(is_removed=False), name="folk_attendee")
        ]
        indexes = [
            GinIndex(fields=['infos'], name='folkattendee_infos_gin', ),
        ]
