...
class Relation(TimeStampedModel, SoftDeletableModel):
    ...
    reciprocal_ids = ArrayField(verbose_name='corresponding relation ids', base_field=models.BigIntegerField(null=False, blank=False), default=list, blank=True, null=True, help_text="Have to be completely empty or in the shape of '1,2,3', no brackets")
