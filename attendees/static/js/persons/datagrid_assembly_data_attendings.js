Attendees.dataAttendings = {
  init: () => {
    console.log("attendees/static/js/persons/datagrid_assembly_data_attendings.js");
    Attendees.dataAttendings.startDataGrid();
  },

  startDataGrid: () => {
    Attendees.dataAttendings.dataGridOpts['dataSource'] = Attendees.dataAttendings.customStore;
    $("div.attendings").dxDataGrid(Attendees.dataAttendings.dataGridOpts).dxDataGrid("instance");
  },
