...
class SeriesGatheringsViewSet(LoginRequiredMixin, RouteGuard, viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        meet = get_object_or_404(Meet, slug=request.data['meet_slug'], assembly__division__organization=organization)
        tzname = request.COOKIES.get('timezone') or meet.infos['default_time_zone'] or organization.infos['default_time_zone'] or settings.CLIENT_DEFAULT_TIME_ZONE
