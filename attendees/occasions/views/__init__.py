...
from .page.datagrid_user_organization_attendances import datagrid_user_organization_attendances_list_view
from .page.datagrid_coworker_organization_attendances import datagrid_coworker_organization_attendances_list_view
...
from .api.family_organization_attendances import api_family_organization_attendances_viewset
from .api.family_organization_characters import api_family_organization_characters_viewset
from .api.family_organization_gatherings import api_family_organization_gatherings_viewset
