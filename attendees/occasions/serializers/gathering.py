...
class GatheringSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        print("hi 17 here is validated_data: "); print(validated_data)
    ...
    def update(self, instance, validated_data):
        ...
        """
        print("hi 30 here is instance: "); print(instance)
        print("hi 31 here is validated_data: "); print(validated_data)
        obj, created = Gathering.objects.update_or_create(
            id=instance.id,
            defaults=validated_data,
        )
