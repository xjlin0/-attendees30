...
class MessageTemplate(TimeStampedModel, SoftDeletableModel):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['organization', 'type'], condition=models.Q(is_removed=False), name='organization_type'),
        ]
...
#     variables = JSONField(null=True, blank=True, default=dict, help_text='Example: {"name": "John", "Date": "08/31/2020"}. Please keep {} here even no data')
#
#     class Meta:
